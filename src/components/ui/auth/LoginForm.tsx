    ...
    <Card>
      <CardContent>
        ...
        <div className="flex rounded-lg bg-muted p-1 mb-6">
          ...
          <Button type="button" variant="ghost" className="flex-1" onClick={onSwitchToRegister}>
            註冊
          </Button>
        </div>
        ...
        {/* 錯誤訊息 */}
        {error && (
          <div className="mb-4 rounded-ld bg-destructive/10 p-3 text-sm text-destructive">
            {error}
          </div>
        )}
